...
// Primary Colors
const Color primaryRed = Color.fromARGB(242, 255, 56, 49); // Bright Red
...
const Color primaryGrey = Color.fromARGB(118, 159, 159, 159);
const Color primaryLightGrey = Color.fromARGB(58, 159, 158, 158);
const Color primaryDarkGrey = Color.fromARGB(161, 54, 54, 54);
